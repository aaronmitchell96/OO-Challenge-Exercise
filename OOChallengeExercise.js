...
// Part Two
// Create a class for a car. The Car class should
//  inherit from Vehicle and each car instance should 
...
// Part Three
// Create a class for a Motorcycle. This class should 
// inherit from Vehicle and each motorcycle instance should 
...
// A garage should also have an add method, which attempts to add a 
// vehicle to the array of vehicles. However, if you try to add 
// something which is not a vehicle, the garage should return the message
